        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              O Plastic Competitive Career é um processo de desenvolvimento de
              carreira voltado para cirurgiões plásticos que decidiram{" "}
              <span className="text-foreground font-medium">
                elevar seu nível competitivo em 2026.
              </span>
            </p>
            ...
            <p className="text-lg text-foreground leading-relaxed">
              O foco está em organizar decisões que realmente sustentam
              crescimento, com visão de médio e longo prazo.
            </p>
