      ...
      <div className="container-document">
        <div className="content-column">
          ...
          >
            ...
            <div className="space-y-3 text-lg md:text-xl text-muted-foreground my-8 max-w-2xl mx-auto text-center">
                    ...
                    <div className="relative z-10 grid grid-cols-6 gap-2 md:gap-3">
                      {features.map((feature, index) => (
                        <motion.div
                          ...
                          className="rounded-lg border bg-card text-card-foreground shadow-sm relative col-span-full overflow-hidden md:col-span-3 hover:shadow-md transition-shadow duration-300"
                        >
            ...
            <p className="text-xl md:text-2xl font-semibold text-primary leading-relaxed mt-6">
              Fazer a aplicação.
            </p>
